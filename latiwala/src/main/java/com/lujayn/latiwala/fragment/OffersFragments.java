 ...
 */
public class OffersFragments extends Fragment implements MainActivity.OnBackPressedListener,
        RequestTaskDelegate {
    View rootView;
...
/*            recyclerView.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(5), true));
            ...
            Log.e("OffersFragments", ":Exception++++++++++++++++++1");
            e.printStackTrace();
        }
    ...
    private void refreshPorductList(String products) {
        ...
        String requestURL = Webservice.BASE_URL + "" + Webservice.get_offers;
...
//                        bean.setCount(object.getString("count"));
            ...
            Log.e("OffersFragments", ":Exception++++++++++++++++++2");
            e.printStackTrace();
        }
            ...
            try {
                ...
                vh.rlProductmain.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra("beanOfferProductList", bean_list);
                        intent.putExtra("parentClassName", "OffersFragment");
                ...
                Log.e("OffersFragments", ":Exception++++++++++++++++++3");
                e.printStackTrace();
            }
